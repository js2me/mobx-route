...
import { RouteViewModel, withRoute } from './route-view-model.js';
...
describe('withRoute', () => {
  ...
  it('does not auto-unmount when route closes', async () => {
    ...
    class TestRouteViewModel extends withRoute(route)(ViewModelBase) {
      override didUnmount() {
        didUnmounts += 1;
      }
    }
  ...
  it('keeps last payload params after route closes', async () => {
    ...
    class Route1VM extends withRoute(route1)(ViewModelBase) {}
    class Route2VM extends withRoute(route2)(ViewModelBase) {}
